...
@interface APLViewController () <ReachabilityDelegate>
...
- (void)viewDidLoad
{
    ...
    self.hostReachability.reachabilityDelegate = self;
    self.internetReachability.reachabilityDelegate = self;
...
-(void)reachabilityStatusDidChange:(Reachability *)reachability
{
